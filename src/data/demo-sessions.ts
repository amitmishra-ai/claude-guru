...
export const demoLearnerRatingsBySessionId: Record<string, LearnerRating[]> = {
  ...
  "comb-done-a": [
    { learnerName: "Aarav", rating: 4.7, feedback: "Great stats session, well explained." },
    { learnerName: "Nisha", rating: 4.5, feedback: "Descriptive stats were very clear." },
    { learnerName: "Rohan", rating: 4.3, feedback: "Good examples with real datasets." },
  ],
  "comb-done-b": [
    { learnerName: "Meera", rating: 3.8, feedback: "Pace was a bit fast for our batch." },
    { learnerName: "Kabir", rating: 3.9, feedback: "Needed more practice problems." },
    { learnerName: "Isha", rating: 3.7, feedback: "Could use more interactive examples." },
  ],
  c2: [
