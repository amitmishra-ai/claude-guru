...
export const demoSessions: Session[] = [
  ...
  // ── Upcoming / scheduled sessions ──
  {
    ...
    totalEarningsInr: 18000,
    combinedBatches: [
      { batch: "AIML Online March 26 A", group: "Group 02 (Mixed work, beginner prog)" },
      { batch: "AIML Online Jan 26 B", group: "Group 04 (High work, beginner prog)" },
      { batch: "PGP-DS Online Feb 26 A", group: "Group 06 (Beginner)" },
    ],
  },
  {
    id: "s0d",
...
export const demoRatingHistory: RatingHistoryEntry[] = [
  { id: "s0", title: "Program Overview (All)", group: "Group 02 (Mixed work, beginner prog)", dateYmd: "2026-03-25", score: 4.71, feedback: "Great orientation and industry landscape overview." },
  { id: "s0b", title: "Program Overview (All)", group: "Group 03 (Mixed)", dateYmd: "2026-03-25", score: 4.86, feedback: "Excellent AI case study discussion." },
  { id: "s0c2", title: "Data Visualization using Tableau", group: "Group 05 (Low work, high prog)", dateYmd: "2026-04-05", score: 4.84, feedback: "Interactive dashboards session was very helpful." },
  { id: "s0d", title: "Introduction to SQL", group: "Group 04 (High work, beginner prog)", dateYmd: "2026-03-24", score: 4.92, feedback: "Querying data with SQL explained brilliantly." },
