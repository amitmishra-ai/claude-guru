...
export const demoSessions: Session[] = [
  ...
  {
    id: "today2",
    title: "Mentor Session: Clustering Techniques",
...
export const demoLearnerRatingsBySessionId: Record<string, LearnerRating[]> = {
  c1: [
    { learnerName: "Priya", rating: 4.9, feedback: "Excellent Python walkthrough." },
    { learnerName: "Karthik", rating: 4.7, feedback: "Great practical examples." },
    { learnerName: "Meera", rating: 4.8, feedback: "Very helpful for beginners." },
  ],
  c2: [
