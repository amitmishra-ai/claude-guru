...
export const demoSessions: Session[] = [
  ...
  // ── Residency sessions ──
  {
    ...
    residencySchedule: [
      { dateYmd: "2026-02-08", start: minutes(9), end: minutes(17) },
      { dateYmd: "2026-02-09", start: minutes(9), end: minutes(17) },
      { dateYmd: "2026-02-10", start: minutes(9), end: minutes(17) },
    ],
  },
  {
    id: "res-combined",
    ...
    linkedCourseId: "p1",
    residencySchedule: [
      { dateYmd: "2026-03-27", start: minutes(9), end: minutes(17) },
      { dateYmd: "2026-03-28", start: minutes(9), end: minutes(17) },
      { dateYmd: "2026-03-29", start: minutes(9), end: minutes(17) },
    ],
  },
  {
    id: "res2",
    ...
    residencySchedule: [
      ...
      { dateYmd: "2026-04-03", start: minutes(9), end: minutes(17) },
      { dateYmd: "2026-04-04", start: minutes(9), end: minutes(17) },
    ],
    combinedBatches: [
      {
  ...
  // ── Individual 1:1 session ──
  {
    ...
    paymentModel: "fixed",
    combinedBatches: [
      { batch: "PGP-AIML-BA-UTA-Nov25-C", group: "1:1", audienceType: "Individual", learnerName: "Ananya Deshmukh", learnerEmail: "ananya.d.ml@gmail.com", learnerCount: 1 },
    ],
  },
  {
    id: "comb-done-a",
...
export const demoLearnerRatingsBySessionId: Record<string, LearnerRating[]> = {
  ...
  career1: [
    { learnerName: "Sanya", rating: 5.0, feedback: "Very helpful career guidance." },
    { learnerName: "Vivek", rating: 4.5, feedback: "Great interview tips." },
    { learnerName: "Ananya", rating: 5.0, feedback: "Insightful industry advice." },
    { learnerName: "Rahul", rating: 5.0, feedback: "Portfolio review was excellent." },
    { learnerName: "Kabir", rating: 4.0, feedback: "Good but could cover more roles." },
    { learnerName: "Varun", rating: 5.0, feedback: "Outstanding content and delivery, no complaints at all." },
    { learnerName: "Waseem", rating: 4.5, feedback: "The live demonstrations were incredibly useful." },
    { learnerName: "Yamini", rating: 5.0, feedback: "Perfectly balanced between theory and practice." },
    { learnerName: "Zara", rating: 4.5, feedback: "Great session, the Q&A at the end was very helpful." },
    { learnerName: "Abhishek", rating: 5.0, feedback: "Wonderful session, I would love more like this." },
    { learnerName: "Bindu", rating: 4.5, feedback: "Absolutely brilliant session, learned so much." },
    ...
    { learnerName: "Gauri", rating: 4.0, feedback: "Decent session, slides could have been more detailed." },
    { learnerName: "Harsh", rating: 3.5, feedback: "Content was good, but the session ran a bit long." },
    { learnerName: "Indira", rating: 4.0, feedback: "Enjoyed the session, though some concepts needed more time." },
    { learnerName: "Jayant", rating: 3.5, feedback: "Good overall, a few more worked examples would help." },
    { learnerName: "Kriti", rating: 4.0, feedback: "Fairly well organised, some transitions were abrupt." },
    { learnerName: "Lokesh", rating: 3.0, feedback: "Could not understand the examples, too advanced for me." },
    { learnerName: "Manju", rating: 2.5, feedback: "Expected more beginner-friendly explanations." },
    { learnerName: "Nakul", rating: 2.0, feedback: "The session felt disorganised and hard to follow." },
    { learnerName: "Ojasvi", rating: 1.5, feedback: "Too much content packed into too little time." },
    { learnerName: "Pranav", rating: 3.0, feedback: "Struggled to keep up, needed more breaks." },
    { learnerName: "Rashmi", rating: 2.5, feedback: "The slides were cluttered and hard to read." },
    { learnerName: "Sahil", rating: 2.0, feedback: "Very disappointing, did not meet my expectations." },
    { learnerName: "Trisha", rating: 1.5, feedback: "I was lost after the first fifteen minutes." },
    { learnerName: "Uday", rating: 3.0, feedback: "Not enough practical examples to reinforce concepts." },
    { learnerName: "Vandana", rating: 2.5, feedback: "The instructor went too fast and skipped important steps." },
  ],
  ind1: [
...
export const demoFeedbackSummaryBySessionId: Record<string, SessionFeedbackSummary> = {
  ...
  career1: {
    ...
    totalEnrolled: 92,
    parameterRatings: [
      { label: "Concepts covered", fiveStar: 20, fourStar: 11, threeAndBelow: 1 },
      { label: "Concepts explanation", fiveStar: 16, fourStar: 9, threeAndBelow: 1 },
      { label: "Teaching methods used", fiveStar: 7, fourStar: 3, threeAndBelow: 0 },
      { label: "Quality of hands on work", fiveStar: 5, fourStar: 2, threeAndBelow: 0 },
      { label: "Reading and course material", fiveStar: 6, fourStar: 3, threeAndBelow: 0 },
...
export const demoRatingHistory: RatingHistoryEntry[] = [
  { id: "s0", title: "Program Overview (All)", group: "Group 02", dateYmd: "2026-03-25", score: 4.71, feedback: "Great orientation and industry landscape overview." },
  { id: "s0b", title: "Program Overview (All)", group: "Group 03", dateYmd: "2026-03-25", score: 4.86, feedback: "Excellent AI case study discussion." },
  { id: "s0c2", title: "Data Visualization using Tableau", group: "Group 05", dateYmd: "2026-04-05", score: 4.84, feedback: "Interactive dashboards session was very helpful." },
  { id: "s0d", title: "Introduction to SQL", group: "Group 04", dateYmd: "2026-03-24", score: 4.92, feedback: "Querying data with SQL explained brilliantly." },
  { id: "rh1", title: "Python Basics", group: "Group 06", dateYmd: "2026-03-04", score: 4.8, feedback: "Good walkthrough with practical examples." },
  { id: "rh2", title: "SQL Practice", group: "Group 04", dateYmd: "2026-02-25", score: 4.7, feedback: "Clear explanations, needed more time for doubts." },
  { id: "rh3", title: "Statistics Foundations", group: "Group 08", dateYmd: "2026-02-18", score: 4.65, feedback: "Excellent session flow and engagement." },
  ...
  { id: "rh6", title: "Probability Refresher", group: "Group 07", dateYmd: "2026-01-28", score: 4.45, feedback: "Concepts were clear; wanted more solved examples." },
  { id: "rh7", title: "Exploratory Data Analysis", group: "Group 05", dateYmd: "2026-01-21", score: 4.4, feedback: "Very interactive and easy to follow." },
  { id: "rh8", title: "Feature Engineering", group: "Group 03", dateYmd: "2026-01-14", score: 4.35, feedback: "Great tips for real projects." },
  { id: "rh9", title: "Model Evaluation", group: "Group 02", dateYmd: "2026-01-07", score: 4.3, feedback: "Excellent explanation of metrics and tradeoffs." },
...
export const demoCohortStarts: CohortStart[] = [
  { id: "cs1", program: "PGP-DS", cohort: "Cohort Apr", dateYmd: "2026-04-05", note: "New PGP cohort starts" },
  { id: "cs2", program: "PGP-AIML", cohort: "Cohort Apr", dateYmd: "2026-04-02", note: "New PGP cohort starts" },
  { id: "cs3", program: "PGP-BA", cohort: "Cohort Mar", dateYmd: "2026-04-01", note: "New PGP cohort starts" },
];
...
export const demoRoleRatingHistory: Record<GuruRole, RatingHistoryEntry[]> = {
  Teacher: [
    ...
    { id: "t2b", title: "Computer Vision Workshop", group: "Group 01", dateYmd: "2026-03-15", score: 4.85 },
    ...
    { id: "t4b", title: "Statistics Foundations", group: "Group 05", dateYmd: "2026-02-18", score: 4.72 },
    ...
    { id: "t6b", title: "Python for Data Science", group: "Group 02", dateYmd: "2026-01-28", score: 4.68 },
    { id: "t7", title: "Data Engineering Essentials", group: "Group 02", dateYmd: "2025-12-15", score: 4.55 },
    { id: "t7b", title: "Feature Engineering", group: "Group 03", dateYmd: "2025-12-22", score: 4.48 },
    { id: "t8", title: "NLP Advanced Topics", group: "Group 03", dateYmd: "2025-11-20", score: 4.68 },
    { id: "t8b", title: "Time Series Analysis", group: "Group 01", dateYmd: "2025-11-08", score: 4.52 },
    { id: "t9", title: "Deep Learning Fundamentals", group: "Group 04", dateYmd: "2025-10-10", score: 4.62 },
    { id: "t9b", title: "Linear Algebra Refresher", group: "Group 02", dateYmd: "2025-10-22", score: 4.45 },
    { id: "t10", title: "Probability & Statistics", group: "Group 05", dateYmd: "2025-09-15", score: 4.40 },
    { id: "t10b", title: "Introduction to ML", group: "Group 01", dateYmd: "2025-09-28", score: 4.58 },
    { id: "t11", title: "Python Fundamentals", group: "Group 03", dateYmd: "2025-08-18", score: 4.35 },
    { id: "t11b", title: "Data Visualization", group: "Group 04", dateYmd: "2025-08-28", score: 4.42 },
    { id: "t12", title: "SQL for Analytics", group: "Group 02", dateYmd: "2025-07-12", score: 4.30 },
    { id: "t12b", title: "Exploratory Data Analysis", group: "Group 05", dateYmd: "2025-07-25", score: 4.38 },
    { id: "t13", title: "Introduction to Programming", group: "Group 01", dateYmd: "2025-06-10", score: 4.25 },
    { id: "t13b", title: "Math for ML", group: "Group 03", dateYmd: "2025-06-22", score: 4.32 },
    { id: "t14", title: "Orientation Session", group: "Group 04", dateYmd: "2025-05-15", score: 4.20 },
    { id: "t14b", title: "Program Overview", group: "Group 02", dateYmd: "2025-05-25", score: 4.28 },
    { id: "t15", title: "Industry Guest Lecture", group: "Group 01", dateYmd: "2025-04-10", score: 4.15 },
    { id: "t15b", title: "Welcome Session", group: "Group 05", dateYmd: "2025-04-22", score: 4.22 },
  ],
  "Course Mentor": [
